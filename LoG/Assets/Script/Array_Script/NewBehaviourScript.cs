...
public class Arrayment_Manager : MonoBehaviour
{
                ...
                case (int)ArrayPhase.SECOND12:
                    ...
                    if (arrData_Sync.is_datasync == true)
                    {
                        if (Arrayed_Data.instance.team2[0].GetComponent<Character>().character_ID != 0)
                        {
                            ...
                            Enemy_Grids[cancle_num - 1].GetComponent<Character>().Character_Reset();
                            Enemy_Grids[cancle_num - 1].GetComponent<Character>().Debuging_Character();
                ...
                case (int)ArrayPhase.SECOND12:
                    ...
                    if (On_Raycast == true)
                    {
                        ...
                        if (Order[0].tag == "Character" && Order[1].tag == "Character")
                        {
                            if (Ready_Array == true)
                            {
                                Order[1].GetComponent<Character>().character_Attack_Order = 1;
                                Order[2].GetComponent<Character>().character_Attack_Order = 2;
                                Arrayed_Data.instance.team1[0].GetComponent<Character>().Debuging_Character();
                                Arrayed_Data.instance.team1[1].GetComponent<Character>().Debuging_Character();
                                Debug.Log((ArrayPhase)Phase + "배치 완료");
                                arrRoomManager.StartArrayPhase();
                ...
                case (int)ArrayPhase.SECOND34:
                    ...
                    if (On_Raycast == true)
                    {
                        ...
                        if (Order[2].tag == "Character" && Order[3].tag == "Character")
                        {
                            if (Ready_Array == true)
                            {
                                Order[1].GetComponent<Character>().character_Attack_Order = 3;
                                Order[2].GetComponent<Character>().character_Attack_Order = 4;
                                Arrayed_Data.instance.team1[2].GetComponent<Character>().Debuging_Character();
                                Arrayed_Data.instance.team1[3].GetComponent<Character>().Debuging_Character();
                                Debug.Log((ArrayPhase)Phase + "배치 완료");
                                arrRoomManager.StartArrayPhase();
    ...
    private void Cancle_Sync(int num)
    {
        if (PV.IsMine == true)
        {
            ...
            cancle_num = Reverse_Array(Arrayed_Data.instance.team2[num].GetComponent<Character>().character_Num_Of_Grid);
            ...
            else
            {
                ...
                {
                    if (Arrayed_Data.instance.team1[i + 1].GetComponent<Character>().character_ID != 0)
                    {
