...
public class Character : MonoBehaviourPunCallbacks
{
    ...
    protected void setting_skill(int num)
    {
        ...
        switch ((string)character_data[num]["Skill"])
        {
            ...
            case "Null":
                {
                    if(character_Type == CharacterType.Attacker)
                        character_Skill = CharacterSkill.Attack_Null;
                    if (character_Type == CharacterType.Balance)
                        character_Skill = CharacterSkill.Balance_Null;
                    if (character_Type == CharacterType.Defender)
    ...
    public void PVE_Enemy_Character_Setting(int num,string StageName)
    {
        ...
        character_Attack_Order = (int)character_data[num]["Number"];
        Setting_AttackRange(num);
    }
