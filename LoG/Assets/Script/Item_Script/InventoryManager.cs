...
public class InventoryManager : MonoBehaviour
{
    ...
    public void AddGold()
    {
        ...
        PlayFabClientAPI.AddUserVirtualCurrency(request, (result) => print("100 골드 획득"), (error) => print("골드 획득 실패"));
        GetInventory();
    }
    ...
    public void SubtractGold()
    {
        ...
        PlayFabClientAPI.SubtractUserVirtualCurrency(request, (result) => print("100 골드 차감"), (error) => print("골드 차감 실패"));
        GetInventory();
    }
    ...
    public void BuyApple()
    {
        ...
        PlayFabClientAPI.PurchaseItem(request, (result) => print("사과 구입"), (error) => print("사과 구입 실패"));
        GetInventory();
    }
    ...
    public void BuyPeach()
    {
        ...
        PlayFabClientAPI.PurchaseItem(request, (result) => print("복숭아 구입"), (error) => print("복숭아 구입 실패"));
        GetInventory();
    }
    ...
    public void EatApple()
    {
        ...
        PlayFabClientAPI.ConsumeItem(request, (result) => print("사과를 먹었다."), (error) => print("사과를 먹지 못했다."));
        GetInventory();
    }
    ...
    public void EatPeach()
    {
        ...
        PlayFabClientAPI.ConsumeItem(request, (result) => print("복숭아를 먹었다."), (error) => print("복숭아를 먹지 못했다."));
        GetInventory();
    }
}
